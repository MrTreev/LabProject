...
# ACDS 21.1 842 linux 2022.05.10.22:38:32
# ----------------------------------------
...
# ----------------------------------------
# If PLLPixelClock is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PLLPixelClock"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/opt/intelFPGA/21.1/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLLPixelClock.vo"
}
